...
addSearchAlias('ma', 'missav', 'https://missav.ai/ja/search/{0}/', 's');
...
settings.lurkingPattern = /.*jable.*|.*fs1\.app|.*missav.*|.*youtube.*|.*playav.*|.*taiav.*|.*bilibili|.*acfun.*|yalist\.unionall\.fun|.*hsex\.men.*|.*rou\.video.*|.*xchina\.co.*|.*mail.google.com.*|.*inbox.google.com.*|localhost|127.0.0.1.*|.*service.?now\.com.*|.*pan1\.me.*/i;
//settings.blocklistPattern = /.*mail.google.com.*|.*inbox.google.com.*|trello.com|feishu.cn|inoreader.com|route.asus.com|rsshub.unionall.fun|yarr.unionall.fun|yarrr.unionall.fun|localhost|127.0.0.1.*|114\.96/i;
