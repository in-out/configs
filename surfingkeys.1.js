...
addSearchAlias('zz', 'zhaoziyuan', 'https://zhaoziyuan.me/sok?filename=', 's');
...
settings.lurkingPattern = /.*jable.*|.*missav.*|.*bilibili.*|list\.airsee\.xyz|.*youtube.*|.*hsex\.men.*|.*playav\.tv.*|.*taiav.*|.*rou\.video.*/i;
